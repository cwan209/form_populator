...
class TestLoadOrders(unittest.TestCase):
    ...
    def test_groups_by_person(self):
        df = self._make_df([
            ...
            {"收件人姓名": "王芳", "电话": "13800000001", "收货地址": "广东省深圳市某街道", "快递品牌": "TimTam", "快递名称": "原味饼干", "快递系数": 2, "备注": ""},
            {"收件人姓名": "李明", "电话": "13800000002", "收货地址": "上海市浦东某路", "快递品牌": "Swisse", "快递名称": "鱼油", "快递系数": 5, "备注": ""},
        ])
    ...
    def test_notes_read_from_备注(self):
        df = self._make_df([
            {"收件人姓名": "王芳", "电话": "13800000001", "收货地址": "广东省深圳市某街道", "快递品牌": "Weet-Bix", "快递名称": "儿童麦片", "快递系数": 1, "备注": "请轻放"},
        ])
        orders = load_orders(df)
    ...
    def test_empty_notes_is_empty_string(self):
        df = self._make_df([
            {"收件人姓名": "王芳", "电话": "13800000001", "收货地址": "广东省深圳市某街道", "快递品牌": "Weet-Bix", "快递名称": "儿童麦片", "快递系数": 1, "备注": float("nan")},
        ])
        orders = load_orders(df)
    ...
    def test_skips_empty_product_name(self):
        df = self._make_df([
            {"收件人姓名": "王芳", "电话": "13800000001", "收货地址": "广东省深圳市某街道", "快递品牌": "Weet-Bix", "快递名称": "", "快递系数": 1, "备注": ""},
            {"收件人姓名": "王芳", "电话": "13800000001", "收货地址": "广东省深圳市某街道", "快递品牌": "TimTam", "快递名称": "原味饼干", "快递系数": 2, "备注": ""},
        ])
        orders = load_orders(df)
